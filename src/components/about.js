	...
	return (
		<section className='about-wrapper'>
			<article className='history-wrapper'>
				<h2 className='history-header'>Краткая история компании</h2>
				<span className='history-text'>
					Наша компания была основана в 2002 году 3 директорами, уставшими от несправедливости, творившейся в
					нашем мире. Они подумали и решили сделать то, чего не делал еще никто до них - по-настоящему честный
					продукт, компанию, которой люди смогут по-настоящему доверять. И они основали "Honest
					Broker"(честный брокер). И вот, теперь мы имеем тысячи довольных клиентов, офисы по всему миру и
					одни из лучших условий на рынке инвестиций.
